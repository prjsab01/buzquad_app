...
mkdir android-twa
cd android-twa
bubblewrap init --manifest https://buzquad.pages.dev/manifest.json
```
...
| Start URL | `https://buzquad.pages.dev/` |
| Display mode | `standalone` |
| Status bar color | `#0f172a` |
| Nav bar color | `#0f172a` |
| Splash screen color | `#0f172a` |
| Icon URL | `https://buzquad.pages.dev/icons/icon-512.svg` |
| Maskable icon URL | `https://buzquad.pages.dev/icons/icon-512.svg` |
...
Cloudflare Pages will serve it at `https://buzquad.pages.dev/.well-known/assetlinks.json`.
